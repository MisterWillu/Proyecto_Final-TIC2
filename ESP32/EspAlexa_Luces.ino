/**********************************************************************************
 *  TITLE: Manual (Push Button) + Alexa control 8 channel Relay Module using ESP32 | with feedback
...
// device names
String Device_1_Name = "Pieza 1";
String Device_2_Name = "Pieza 2";
String Device_3_Name = "Baño 1";
String Device_4_Name = "Baño 2";
String Device_5_Name = "Cocina";
String Device_6_Name = "Luz Calle";
String Device_7_Name = "Ventilador";
